...
internal static class ServerContentIoC
{
    public static void Register(IDependencyCollection deps)
    {
        ...
        deps.Register<AIManager>(); // stalker-changes-auth
        deps.Register<DiscordAuthManager>(); // stalker-changes-auth
        deps.Register<JoinQueueManager>(); // stalker-changes - Corvax Queue Adaptation
        deps.Register<SponsorsManager>(); // stalker-changes-sponsors
        deps.Register<BanWebhook>(); // stalker-changes-bans
        deps.Register<_Stalker.ServerAdministration.ServerApi>(); // Stalker-Changes - Stalker Server API
    }
}
