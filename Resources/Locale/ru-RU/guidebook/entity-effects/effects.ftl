    ...
    { $type ->
        ...
        [add]
            { $chance ->
                [1] Вызывает
               *[other] вызывают
            } оглушение минимум на { NATURALFIXED($time, 3) }, эффект накапливается
       *[set]
            { $chance ->
                [1] Вызывает
               *[other] вызывают
            } оглушение минимум на { NATURALFIXED($time, 3) }, эффект не накапливается
        [remove]
            { $chance ->
                [1] Удаляет
               *[other] удаляют
            } { NATURALFIXED($time, 3) } от оглушения
    }
